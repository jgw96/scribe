...
import { modalController, loadingController, alertController, toastController } from '@ionic/core';
...
export class AppCamera {
  ...
  async takePicture() {
    ...
    setTimeout(async () => {
      ...
      if (textData.recognitionResults[0].lines.length > 0) {
        textLines = textData.recognitionResults[0].lines;
      }
      ...
      if (textLines) {
        ...
        const toast = await toastController.create({
          message: "No text identified, take another picture",
          duration: 1400
        });
        await toast.present();
      }
